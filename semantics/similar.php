...
/*
 * SEO Tools.
 * Определение похожих запросов из списка
 */
...
function translit($string){
	...
	return $string;
} //функция обработки транслита
 
/* 1. базовый пример */
#echo 'Арнольд Шварцнеггер '.implode(' ', dmstring('Арнольд Шварцнеггер'))."<br>";
#echo 'Arnold Schwarzenegger '.implode(' ', dmstring('Arnold Schwarzenegger'))."<br>";
#echo 'Орнольд Шворцнегир '.implode(' ', dmstring('Орнольд Шворцнегир'))."<br>";
 
/* 2. пример выгрузки запросов из списка 
$list = file_get_contents('/key.txt');
$num = explode("\r\n", $list);

 for($i=0; $i < count($num); $i++){ 
     echo $num[$i].' '.implode(' ', dmstring($num[$i]))."<br>";
 }
*/
?>